...
@Component
@AllArgsConstructor
public class CheckOrderBelongsToMeForStartStoreWiring implements ConstraintValidator<CheckOrderBelongsToMeForStartStore, Long> {
    ...
    public boolean isValid(Long id, ConstraintValidatorContext context) {
        ...
        return Objects.equals(order.getStartStore().getAdmin().getId(), me.getId());
    }
}
