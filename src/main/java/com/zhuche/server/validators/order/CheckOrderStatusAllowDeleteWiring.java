...
@Component
@AllArgsConstructor
public class CheckOrderStatusAllowDeleteWiring implements ConstraintValidator<CheckOrderStatusAllowDelete, Long> {
    ...
    public boolean isValid(Long id, ConstraintValidatorContext context) {
        ...
        return order.getStatus() ==  OrderStatus.CANCELED || order.getStatus() ==  OrderStatus.FINISHED;
    }
}
