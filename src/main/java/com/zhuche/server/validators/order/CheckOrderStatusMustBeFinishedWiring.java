...
@Component
@AllArgsConstructor
public class CheckOrderStatusMustBeFinishedWiring implements ConstraintValidator<CheckOrderStatusMustBeFinished, Long> {
    ...
    public boolean isValid(Long id, ConstraintValidatorContext context) {
        ...
        return order.getStatus() == OrderStatus.FINISHED;
    }
}
