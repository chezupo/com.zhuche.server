...
@Component
@AllArgsConstructor
public class CheckOrderStatusMustBeReturningWiring implements ConstraintValidator<CheckOrderStatusMustBeReturning, Long> {
    ...
    public boolean isValid(Long id, ConstraintValidatorContext context) {
        ...
        return order.getStatus() == OrderStatus.RETURNING;
    }
}
