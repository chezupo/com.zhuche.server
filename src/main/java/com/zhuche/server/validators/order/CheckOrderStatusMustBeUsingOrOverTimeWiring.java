...
@Component
@AllArgsConstructor
public class CheckOrderStatusMustBeUsingOrOverTimeWiring implements ConstraintValidator<CheckOrderStatusMustBeUsingOrOverTime, Long> {
    ...
    public boolean isValid(Long id, ConstraintValidatorContext context) {
        ...
        return order.getStatus() == OrderStatus.USING || order.getStatus() == OrderStatus.OVERTIME;
    }
}
