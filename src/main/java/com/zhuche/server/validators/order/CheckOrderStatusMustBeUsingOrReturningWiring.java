...
@Component
@AllArgsConstructor
public class CheckOrderStatusMustBeUsingOrReturningWiring implements ConstraintValidator<CheckOrderStatusMustBeUsingOrReturning, Long> {
    ...
    public boolean isValid(Long id, ConstraintValidatorContext context) {
        ...
        return order.getStatus() == OrderStatus.USING || order.getStatus() == OrderStatus.RETURNING;
    }
}
