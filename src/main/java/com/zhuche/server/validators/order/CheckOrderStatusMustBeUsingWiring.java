...
@Component
@AllArgsConstructor
public class CheckOrderStatusMustBeUsingWiring implements ConstraintValidator<CheckOrderStatusMustBeUsing, Long> {
    ...
    public boolean isValid(Long id, ConstraintValidatorContext context) {
        ...
        return order.getStatus() == OrderStatus.USING;
    }
}
